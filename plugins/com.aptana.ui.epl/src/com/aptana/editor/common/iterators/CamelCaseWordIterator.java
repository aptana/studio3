 ...
 * @since 3.0
 */
public class CamelCaseWordIterator extends BreakIterator
{

	/**
	 * The underlying java break iterator. It returns all breaks, including before and after every whitespace.
	 */
	private CamelCaseBreakIterator fIterator;
	 ...
	 */
	public CamelCaseWordIterator()
	{
		fIterator = new CamelCaseBreakIterator();
		first();
	}
