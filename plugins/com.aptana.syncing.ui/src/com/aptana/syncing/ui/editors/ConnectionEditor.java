 ...
 */
package com.aptana.syncing.ui.editors;
...
import com.aptana.syncing.ui.views.FTPManagerComposite;
...
public class ConnectionEditor extends EditorPart implements FTPManagerComposite.Listener {
     ...
     * ID of the editor
     */
    public static final String ID = "com.aptana.syncing.ui.editors.ConnectionEditor"; //$NON-NLS-1$
