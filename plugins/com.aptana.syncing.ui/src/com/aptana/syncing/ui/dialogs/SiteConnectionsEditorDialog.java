...
import com.aptana.syncing.ui.internal.SiteConnectionPropertiesWidget;
	...
	protected boolean doSelectionChange() {
		if (sitePropertiesWidget.isChanged()) {
			MessageDialog dlg = new MessageDialog(getShell(), Messages.SiteConnectionsEditorDialog_SaveConfirm_Title,
				null,
				MessageFormat.format(Messages.SiteConnectionsEditorDialog_SaveConfirm_Message, sitePropertiesWidget.getSource().getName()),
