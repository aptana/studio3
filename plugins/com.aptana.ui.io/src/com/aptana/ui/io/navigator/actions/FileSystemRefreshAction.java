 ...
 */
package com.aptana.ui.io.navigator.actions;
...
public class FileSystemRefreshAction extends BaseSelectionListenerAction {
    ...
    public FileSystemRefreshAction() {
        super(Messages.FileSystemRefreshAction_Text);
        setImageDescriptor(IOUIPlugin
                .getImageDescriptor("/icons/full/etool16/refresh.png")); //$NON-NLS-1$
