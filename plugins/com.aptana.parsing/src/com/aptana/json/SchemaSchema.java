...
//		Property schema_name = new Property("name", "String");
//		Property schema_result = new Property("result", "<type-spec>");
//
//		schema_value.addProperty(schema_name);
//		schema_value.addProperty(schema_result);
//
//		Property schema_property = new Property("schema", "Schema");
//		document_value.addProperty(schema_property);
//		
//		// create types
//		Type schema_type = new Type("Schema", schema_value);
//		Type document_type = new Type("SchemaDocument", document_value);
//
