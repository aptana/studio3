...
public class DiffDocumentProvider extends CommonDocumentProvider
{
	...
	public void connect(Object element) throws CoreException
	{
		...
		if (document != null)
		{
			IDocumentPartitioner partitioner = new FastPartitioner(new DiffSourcePartitionScanner(),
			...
			CommonEditorPlugin.getDefault().getDocumentScopeManager().registerConfiguration(document,
					DiffSourceConfiguration.getDefault());
		}
	}
