...
public class RubyFormatterIndentationTabPage extends FormatterModifyTabPage
{
	...
	protected void createOptions(final IFormatterControlManager manager, Composite parent)
	{
		...
		//
		Group indentGroup = SWTFactory.createGroup(parent, "Indent within definitions", 1, 1, GridData.FILL_HORIZONTAL);
		manager.createCheckbox(indentGroup, RubyFormatterConstants.INDENT_CLASS, "Declarations within class body");
		manager.createCheckbox(indentGroup, RubyFormatterConstants.INDENT_MODULE, "Declarations within module body");
		manager.createCheckbox(indentGroup, RubyFormatterConstants.INDENT_METHOD, "Statements within method body");
		Group indentBlocks = SWTFactory.createGroup(parent, "Indent within blocks", 1, 1, GridData.FILL_HORIZONTAL);
		manager.createCheckbox(indentBlocks, RubyFormatterConstants.INDENT_BLOCKS, "Statements within blocks body");
		manager.createCheckbox(indentBlocks, RubyFormatterConstants.INDENT_IF, "Statements within 'if' body");
		manager.createCheckbox(indentBlocks, RubyFormatterConstants.INDENT_CASE, "Statements within 'case' body");
		manager.createCheckbox(indentBlocks, RubyFormatterConstants.INDENT_WHEN, "Statements within 'when' body");
	}
