 ...
 * @author Max Stepanov
 */
class ResumableMultiLineRule extends FixedMultiLineRule implements IResumableRule
{
	 ...
	 * @param breaksOnEOF
	 */
	ResumableMultiLineRule(String startSequence, String endSequence, IToken token, char escapeCharacter,
			boolean breaksOnEOF)
	{
