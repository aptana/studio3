...
/**
 * This extension will make sure that the colors for the console are always following
...
public class ConsoleThemer 
{
	...
	public static final String CONSOLE_TRACE = CONSOLE_PROMPT; //$NON-NLS-1$
	public static final String CONSOLE_INFO = CONSOLE_INPUT; //$NON-NLS-1$
	...
	/**
	 * Should be called in the UI thread. Usually, there's no way to create
	 * this extension from any console, as the ConsoleThemePageParticipant takes
	 * care of that for all consoles (provided they are properly configured).
	 * 
	 * @see ConsoleThemePageParticipant
	 * 
	 * @param textConsole console with the streams.
