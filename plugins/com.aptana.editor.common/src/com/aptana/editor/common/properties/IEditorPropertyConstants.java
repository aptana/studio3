...
public interface IEditorPropertyConstants
{
	...
	public static final String SCOPE_LABEL = Messages.IEditorPropertyConstants_scope;

	public static final String TEXT_LABEL = Messages.IEditorPropertyConstants_text;

	public static final String OFFSET_START_LABEL = Messages.IEditorPropertyConstants_offset_start;

	public static final String OFFSET_END_LABEL = Messages.IEditorPropertyConstants_offset_end;
