...
public class CommonAutoIndentStrategy implements IAutoEditStrategy {
    ...
    /**
     * Calculates the whitespace prefix based on user preferences and the
     * existing line, e.g. if the line prefix is five spaces, and user pref is
     * tabs of width 4, then the result will be "/t ".
     * 
     * @param d
     *            the document
     * @param offset
     ...
     * 
     * @return Returns the whitespace prefix based on user preferences and the
     *         existing line
     */
