...
public class SnippetConverter
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		{
			args = new String[] { userHome + "/Documents/RadRails Bundles/rails.ruble/Snippets" };
		}
		String outputFilePath;
		if (args.length < 2)
		{
			outputFilePath = userHome + "/Documents/RadRails Bundles/rails.ruble/Snippets/snippets.rb";
		}
		else
		{
