...
public class CSSTokenScanner extends BufferedRuleBasedScanner {
    ...
    private static final String[] DEPRECATED_COLORS = new String[] { "aliceblue", "antiquewhite",
    ...
    @SuppressWarnings("nls")
    private static final String[] STANDARD_COLORS = { "aqua", "black", "blue", "fuchsia", "gray",
    ...
    @SuppressWarnings("nls")
    private static final String[] MEDIAS = { "all", "aural", "braille", "embossed", "handheld",
    ...
    private static final String[] PROPERTY_NAMES = { "azimuth", "background-attachment",
            ...
            "background-position-y", "background-position", "background-repeat", "background",
            "border-bottom-color", "border-bottom-style", "border-bottom-width", "border-bottom",
            "border-collapse", "border-color", "border-left-color", "border-left-style",
            "border-left-width", "border-left", "border-right-color", "border-right-style",
            "border-right-width", "border-right", "border-spacing", "border-style",
            "border-top-color", "border-top-style", "border-top-width", "border-top",
            "border-width", "border", "bottom", "caption-side", "clear", "clip", "color",
            "content", "counter-increment", "counter-reset", "cue-after", "cue-before", "cue",
            "cursor", "direction", "display", "elevation", "empty-cells", "float", "font-family",
            "font-size-adjust", "font-size", "font-stretch", "font-style", "font-variant",
            ...
            "margin", "marks", "max-height", "max-width", "min-height", "min-width",
            "-moz-border-radius", "opacity", "orphans", "outline-color", "outline-style",
            "outline-width", "outline", "overflow-x", "overflow-y", "overflow", "padding-bottom",
            "padding-left", "padding-right", "padding-top", "padding", "page-break-after",
            "page-break-before", "page-break-inside", "page", "pause-after", "pause-before",
            "pause", "pitch-range", "pitch", "play-during", "position", "quotes", "richness",
            "right", "size", "speak-header", "speak-numeral", "speak-punctuation", "speech-rate",
            "speak", "stress", "table-layout", "text-align", "text-decoration", "text-indent",
    ...
    @SuppressWarnings("nls")
    private static final String[] FONT_NAMES = { "arial", "century", "comic", "courier",
            "garamond", "geneva", "georgia", "helvetica", "impact", "lucida", "monaco", "symbol",
            "system", "tahoma", "times", "trebuchet", "utopia", "verdana", "webdings",
            "sans-serif", "serif", "monospace" };

    /**
     * A flag to turn on or off the optimization of eligible regexp rules. Seems
     * to make a measurable difference on large files.
     */
    ...
    public CSSTokenScanner() {
        ...
        // @ rules
        rules.add(new RegexpRule("@[_a-zA-Z0-9-]+", createToken(getTokenName(CSSTokens.AT_KEYWORD)), OPTIMIZE_REGEXP_RULES)); //$NON-NLS-1$
