...
public class CSSTokens
{
	...
	private static final String[] NAMES = { "EOF", "IDENTIFIER", "COLOR", "COLON", "RCURLY", "SEMICOLON", "LBRACKET",
			"CLASS", "HASH", "STRING", "STAR", "SELECTOR", "FUNCTION", "URL", "LCURLY", "COMMA", "NUMBER",
			"PERCENTAGE", "LENGTH", "EMS", "EXS", "ANGLE", "TIME", "FREQUENCY", "PAGE", "AT_KEYWORD", "CHARSET",
			"MEDIA", "RBRACKET", "IMPORT", "PROPERTY", "PLUS", "FORWARD_SLASH", "MINUS", "RPAREN", "IMPORTANT",
			"GREATER", "EQUAL", "INCLUDES", "DASHMATCH", "COMMENT" };
