...
public enum CSSTokenType implements ITypePredicate
{
	...
	LCURLY("punctuation.section.property-list.css", 12), //$NON-NLS-1$
	...
	COMMENT("comment.block.css", 41), //$NON-NLS-1$	
	COMMA("punctuation.separator.css", 15), //$NON-NLS-1$
	SLASH("punctuation.slash.css", 33), //$NON-NLS-1$
	STAR("punctuation.asterisk.css", 10), //$NON-NLS-1$
	PERCENTAGE("keyword.other.unit.css", 18),
	...
	SELECTOR(".css", 11),
	URL(".css", 14),
	LENGTH("keyword.other.unit.css", 19),
	EMS("keyword.other.unit.css", 20),
	EXS("keyword.other.unit.css", 21),
	ANGLE("keyword.other.unit.css", 22),
	TIME("keyword.other.unit.css", 23),
	FREQUENCY("keyword.other.unit.css", 24),
	PAGE("keyword.control.at-rule.page.css", 25),
	CHARSET("keyword.control.at-rule.charset.css", 27),
	MEDIA_KEYWORD("keyword.control.at-rule.import.css", 28),
	FONTFACE("keyword.control.at-rule.fontface.css", 29),
	RBRACKET("punctuation.bracket.css", 30),
	IMPORT("keyword.control.at-rule.import.css", 31),
	PLUS("punctuation.plus.css", 32),
	MINUS("punctuation.minus.css", 34),
	LPAREN("punctuation.section.function.css", 13),
	RPAREN("punctuation.section.function.css", 35),
	IMPORTANT("support.constant.property-value.css", 36),
	GREATER("punctuation.greater.css", 37),
	EQUAL("punctuation.equal.css", 38),
	INCLUDES("keyword.control.at-rule.include.css", 39),
	DASHMATCH(".css", 40);
