...
public class CSSCommentIndentStrategy extends CommonAutoIndentStrategy {
    ...
    /**
     * Copies the indentation of the previous line and adds a star. If the doc
     * just started on this line, adds standard method tags and close the doc.
     * 
     * @param d
        ...
        try {
            ...
            if (firstNonWS < offset) {
                if (d.getChar(firstNonWS) == '/') {
                    // multiline comments started on this line
                    ...
                    if (isNewComment(d, offset)) {
                        ...
                        // guard for end of doc (multiline comment at the very
                        // end of doc)
    ...
    private boolean isNewComment(IDocument document, int commandOffset) {
        try {
            ...
            // TODO: String comment =
            // this.getLexemeList().getLexemeFromOffset(commandOffset).getText();
