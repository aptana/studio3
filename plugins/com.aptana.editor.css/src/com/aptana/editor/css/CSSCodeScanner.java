...
public class CSSCodeScanner extends BufferedRuleBasedScanner
{
	...
	private static final String[] PROPERTY_NAMES = { "alignment-adjust", "alignment-baseline", "azimuth",
			...
			"border-width", "border", "bottom", "box-decoration-break", "box-shadow", "box-sizing", "caption-side",
			"clear", "clip", "column-count", "column-gap", "column-rule", "column-width", "color", "content",
			"counter-increment", "counter-reset", "cue-after", "cue-before", "cue", "cursor", "direction", "display",
			"elevation", "empty-cells", "filter", "fit", "fit-position", "float", "font-family", "font-size-adjust",
			...
			"marks", "max-aspect-ratio", "max-color-index", "max-color", "max-device-aspect-ratio",
			"max-device-height", "max-device-width", "max-height", "max-width", "min-aspect-ratio", "min-color-index",
			"min-color", "min-device-aspect-ratio", "min-device-height", "min-device-width", "min-height",
			"min-monochrome", "min-width", "monochrome", "-moz-border-radius", "offx", "offy", "opacity",
			"orientation", "orphans", "outline-color", "outline-offset", "outline-style", "outline-width", "outline",
			...
			"text-transform", "top", "transform", "transition", "unicode-bidi", "vertical-align", "visibility",
			"voice-family", "volume", "weight", "white-space", "widows", "width", "word-spacing", "word-wrap",
			"z-index", "zoom" };
