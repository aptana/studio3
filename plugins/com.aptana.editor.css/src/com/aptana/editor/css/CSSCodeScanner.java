...
public class CSSCodeScanner extends BufferedRuleBasedScanner
{
	...
	public CSSCodeScanner()
	{
		...
		rules.add(new RegexpRule("#[_a-zA-Z0-9-]+", ids, OPTIMIZE_REGEXP_RULES)); //$NON-NLS-1$
		rules.add(new RegexpRule("\\.[_a-zA-Z0-9-]+", classes)); //$NON-NLS-1$
		rules.add(new RegexpRule("@[_a-zA-Z0-9-]+", rule, OPTIMIZE_REGEXP_RULES)); //$NON-NLS-1$
		...
		rules
				.add(new RegexpRule(
						...
						propertyValue));
		rules.add(new RegexpRule("!important", propertyValue, OPTIMIZE_REGEXP_RULES)); //$NON-NLS-1$
		// Font Names
		rules
				.add(new RegexpRule(
