...
public class RubyOutlineLabelProvider extends LabelProvider
{
	...
	private static final Image CLASS = Activator.getImage("icons/class_obj.gif"); //$NON-NLS-1$
	private static final Image MODULE = Activator.getImage("icons/module_obj.gif"); //$NON-NLS-1$
	private static final Image METHOD_PUBLIC = Activator.getImage("icons/method_public_obj.gif"); //$NON-NLS-1$
	private static final Image METHOD_PROTECTED = Activator.getImage("icons/method_protected_obj.gif"); //$NON-NLS-1$
	private static final Image METHOD_PRIVATE = Activator.getImage("icons/method_private_obj.gif"); //$NON-NLS-1$
	...
	private static final Image GLOBAL = Activator.getImage("icons/global_obj.gif"); //$NON-NLS-1$
