...
public class JSONSourceViewerConfiguration extends CommonSourceViewerConfiguration
{
	...
	{
		return TextUtils.combine(new String[][] { { IDocument.DEFAULT_CONTENT_TYPE }, JSONSourceConfiguration.CONTENT_TYPES });
	}
	...
	public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer)
	{
		...
		JSONSourceConfiguration.getDefault().setupPresentationReconciler(reconciler, sourceViewer);
	...
	{
		return JSONSourceConfiguration.getDefault().getTopContentTypes();
	}
}
