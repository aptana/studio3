	...
	protected Symbol invokeReduceAction(int rule_num, int offset)
	{
		switch (rule_num)
		{
			...
			case 12: // Object = LCURLY Entries.e RCURLY
			{
				...
				final JSONNode[] e = _list_e == null ? new JSONNode[0] : (JSONNode[]) _list_e
						.toArray(new JSONNode[_list_e.size()]);
			...
			case 17: // Array = LBRACKET Values.v RBRACKET
			{
				...
				final JSONNode[] v = _list_v == null ? new JSONNode[0] : (JSONNode[]) _list_v
						.toArray(new JSONNode[_list_v.size()]);
