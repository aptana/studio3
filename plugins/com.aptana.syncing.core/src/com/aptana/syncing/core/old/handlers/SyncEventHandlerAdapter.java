 ...
 */
package com.aptana.syncing.core.old.handlers;
...
public abstract class SyncEventHandlerAdapter implements ISyncEventHandler
{
	...
	/**
	 * @see com.aptana.syncing.core.events.sync.ISyncEventHandler#syncContinue(IProgressMonitor)
	 */
	...
	/**
	 * @see com.aptana.syncing.core.events.sync.ISyncEventHandler#syncDone(com.aptana.core.io.syncing.sync.VirtualFileSyncPair, IProgressMonitor)
	 */
	...
	/**
	 * @see com.aptana.syncing.core.events.sync.ISyncEventHandler#syncErrorEvent(com.aptana.core.io.syncing.sync.VirtualFileSyncPair,
	...
	/**
	 * @see com.aptana.syncing.core.events.sync.ISyncEventHandler#syncEvent(com.aptana.core.io.syncing.sync.VirtualFileSyncPair,
	...
	/**
	 * @see com.aptana.syncing.core.events.sync.ISyncEventHandler#syncTransferring(com.aptana.core.io.syncing.sync.VirtualFileSyncPair,
