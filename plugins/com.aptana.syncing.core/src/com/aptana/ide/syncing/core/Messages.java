...
public final class Messages extends NLS {
	...
	/**
	 * SyncDialog_FileManagerName
	 */
	public static String SyncDialog_FileManagerName;

	/**
	 * SyncDialog_GetsNewItemsFromBothDirections
	 */
	public static String SyncDialog_GetsNewItemsFromBothDirections;

	/**
	 * SyncDialog_GettingFileLists
	 */
	public static String SyncDialog_GettingFileLists;

	/**
	 * SyncDialog_Information
	 */
	public static String SyncDialog_Information;

	public static String SyncDialog_LBL_DeleteAllFilesNotOnBothDrives;

	public static String SyncDialog_LBL_DeleteLocalFilesNotOnRemoteDrive;

	public static String SyncDialog_LBL_DeleteRemoteFilesNotOnLocalDrive;

	/**
	 * SyncDialog_LocalPath
	 */
	 ...
	 * SyncManager_Home
	 */
	public static String SyncManager_Home;

	/**
	 * SyncManager_Refresh
	 */
	public static String SyncManager_Refresh;

	/**
	 * SyncManager_Up
	 */
	public static String SyncManager_Up;
	...
	/**
	 * SyncPreview_SynchronizationPreview
	 */
	public static String SyncPreview_SynchronizationPreview;

	/**
	 * SyncPreview_Synchronize
	 */
