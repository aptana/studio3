...
public enum JSTokenType implements ITypePredicate
{
	...
	DEBUGGER(JSLanguageConstants.DEBUGGER, Terminals.DEBUGGER),
	CLASS(JSLanguageConstants.CLASS, Terminals.CLASS),
	ENUM(JSLanguageConstants.ENUM, Terminals.ENUM),
	...
	IMPLEMENTS(JSLanguageConstants.IMPLEMENTS, Terminals.IMPLEMENTS),
	INTERFACE(JSLanguageConstants.INTERFACE, Terminals.INTERFACE),
	LET(JSLanguageConstants.LET, Terminals.LET),
	PACKAGE(JSLanguageConstants.PACKAGE, Terminals.PACKAGE),
	PRIVATE(JSLanguageConstants.PRIVATE, Terminals.PRIVATE),
	PROTECTED(JSLanguageConstants.PROTECTED, Terminals.PROTECTED),
	PUBLIC(JSLanguageConstants.PUBLIC, Terminals.PUBLIC),
	STATIC(JSLanguageConstants.STATIC, Terminals.STATIC),
