...
public abstract class ConnectionPoint extends PlatformObject implements IConnectionPoint, IExecutableExtension {
	...
	/* (non-Javadoc)
	 * @see com.aptana.core.io.IConnectionPoint#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.aptana.core.io.IConnectionPoint#getRootURI()
	 */
	...
	/* (non-Javadoc)
	 * @see com.aptana.core.io.IConnectionPoint#getRoot()
	 */
    ...
    /* (non-Javadoc)
     * @see com.aptana.core.io.IConnectionPoint#connect(org.eclipse.core.runtime.IProgressMonitor)
     */
	...
	/* (non-Javadoc)
	 * @see com.aptana.core.io.IConnectionPoint#connect(boolean, org.eclipse.core.runtime.IProgressMonitor)
	 */
	public void connect(boolean force, IProgressMonitor monitor) throws CoreException {
	}

	/* (non-Javadoc)
	 * @see com.aptana.core.io.IConnectionPoint#isConnected()
	 */
	...
	/* (non-Javadoc)
	 * @see com.aptana.core.io.IConnectionPoint#canDisconnect()
	 */
	...
	/* (non-Javadoc)
	 * @see com.aptana.core.io.IConnectionPoint#disconnect(org.eclipse.core.runtime.IProgressMonitor)
	 */
