...
public class StreamsProxy implements IStreamsProxy {
	private OutputStreamMonitorPublic outMonitor;
	private OutputStreamMonitorPublic errMonitor;
	...
	public StreamsProxy(InputStream outIn, InputStream errIn) {
		outMonitor = new OutputStreamMonitorPublic(outIn, null);
		errMonitor = new OutputStreamMonitorPublic(errIn, null);
