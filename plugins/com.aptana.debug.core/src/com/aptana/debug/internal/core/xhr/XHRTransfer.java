 ...
 */
package com.aptana.debug.internal.core.xhr;
...
class XHRTransfer implements IXHRTransfer {
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#getURL()
	 */
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#getMethod()
	 */
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#getRequestDate()
	 */
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#getRequestHeaders()
	 */
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#getRequestBody()
	 */
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#getResponseDate()
	 */
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#getResponseHeaders()
	 */
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#getResponseBody()
	 */
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#getStatusCode()
	 */
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#getStatusText()
	 */
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#hasError()
	 */
	...
	/**
	 * @see com.aptana.debug.core.xhr.IXHRTransfer#isAuthenticated()
	 */
	...
	private class Header implements IHeader {
		...
		/**
		 * @see com.aptana.debug.core.xhr.IHeader#getName()
		 */
		...
		/**
		 * @see com.aptana.debug.core.xhr.IHeader#getValue()
		 */
