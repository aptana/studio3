...
public class HttpSettingsTab extends AbstractLaunchConfigurationTab
{
	...
	public void initializeFrom(ILaunchConfiguration configuration)
	{
		...
		try
		{
			httpGetQuery.setText(configuration.getAttribute(ILaunchConfigurationConstants.CONFIGURATION_HTTP_GET_QUERY,	StringUtil.EMPTY));
		}
	...
	public Image getImage()
	{
		if (image == null)
		{
			image = DebugUiPlugin.getImageDescriptor("icons/full/obj16/launch-http.gif").createImage(); //$NON-NLS-1$
		}
		return image;
	}
