...
package com.aptana.debug.internal.ui.views;
...
public class AJAXMonitorView extends AbstractDebugView implements IDebugEventSetListener
{
	...
	private void updateTitle()
	{
		...
		setContentDescription(MessageFormat.format(Messages.AJAXMonitorView_items_0,
				new Integer(count))); // count will be formatted as 1,234
	...
	protected void becomesVisible()
	{
		...
		if ( getViewer().getSelection().isEmpty()
				&& (current != null) && (current.getTransfersCount() > 0) )
		{
	...
	public void handleDebugEvents(DebugEvent[] events)
	{
		for (int i = 0; i < events.length; i++)
		{
			...
			else if ((event.getKind() == DebugEvent.TERMINATE) && (source instanceof IDebugTarget || source instanceof IProcess))
			{
