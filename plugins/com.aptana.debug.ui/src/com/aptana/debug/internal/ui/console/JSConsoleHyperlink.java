 ...
 */
package com.aptana.debug.internal.ui.console;
	...
	public void linkActivated()
	{
		try
		{
			...
			MessageDialog.openInformation(
				...
				Messages.getString("JSConsoleHyperlink.Information"), MessageFormat.format(Messages.getString("JSConsoleHyperlink.SourceNotFoundFor_0"), fFilename)); //$NON-NLS-1$ //$NON-NLS-2$
		}
		catch (CoreException e)
		{
			DebugUiPlugin.errorDialog(Messages.getString("JSConsoleHyperlink.ExceptionWhileFollowingLink"), e); //$NON-NLS-1$
		}
	}
