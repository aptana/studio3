...
public class HTMLParser extends Parser implements IParser
{
	...
	static final ParsingTables PARSING_TABLES = new ParsingTables(
			"U9nzKCiEWZ0Gd1PK2YBAHGyUF6lYD$B9ljyw3bW2mUWcipFPcMxQ0bZpWH4oX1WWGXyJE2H"
					...
					+ "6rzBmgEbudLzRSwwcm#9V$iIF$45zLl$FA2yyyyCGTZznponkViZBzWT7Rh63qCYi4diqN8" + "iqZiHCxSVm679Gorm==");
	...
	public HTMLParser()
	{
		...
		{ // [0] Program = Statements.p
					public Symbol reduce(Symbol[] _symbols, int offset)
					{
						final Symbol _symbol_p = _symbols[offset + 1];
						final ArrayList _list_p = (ArrayList) _symbol_p.value;
						final HTMLNode[] p = _list_p == null ? new HTMLNode[0] : (HTMLNode[]) _list_p
								.toArray(new HTMLNode[_list_p.size()]);
				...
				{ // [3] Statement = START_TAG.t Statements.s
					public Symbol reduce(Symbol[] _symbols, int offset)
					{
						...
						final HTMLNode[] s = _list_s == null ? new HTMLNode[0] : (HTMLNode[]) _list_s
								.toArray(new HTMLNode[_list_s.size()]);
						return new HTMLElementNode(t, s, _symbol_t.getStart(), s[s.length - 1].getEnd());
					}
				}, new Action()
				{ // [4] Statement = START_TAG.t Statements.s END_TAG.e
					public Symbol reduce(Symbol[] _symbols, int offset)
					{
						final Symbol _symbol_t = _symbols[offset + 1];
						final String t = (String) _symbol_t.value;
				...
				{ // [5] Statement = START_TAG.t END_TAG.e
					public Symbol reduce(Symbol[] _symbols, int offset)
					{
						final Symbol _symbol_t = _symbols[offset + 1];
						final String t = (String) _symbol_t.value;
				...
				{ // [8] Statement = CssBlock.b
					public Symbol reduce(Symbol[] _symbols, int offset)
					{
						...
						try
						{
							String text = fScanner.getSource().get(_symbol_b.getStart(),
									_symbol_b.getEnd() - _symbol_b.getStart() + 1);
						...
						return new HTMLSpecialNode(HTMLSpecialNode.CSS, nested, _symbol_b.getStart(), _symbol_b
								.getEnd());
					}
				}, new Action()
				{ // [9] Statement = JSBlock.b
					public Symbol reduce(Symbol[] _symbols, int offset)
					{
						final Symbol _symbol_b = _symbols[offset + 1];
						final ArrayList _list_b = (ArrayList) _symbol_b.value;
