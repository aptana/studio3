...
public enum JSTokenType implements ITypePredicate
{
	...
	GREATER_GREATER_GREATER_EQUAL(JSLanguageConstants.GREATER_GREATER_GREATER_EQUAL,
			Terminals.GREATER_GREATER_GREATER_EQUAL),
	...
	public static JSTokenType getFromANTLRType(int type)
	{
		switch (type)
		{
			case JSParser.OpenBrace:
				return LCURLY;
			case JSParser.CloseBrace:
				return RCURLY;
			case JSParser.OpenBracket:
				return LBRACKET;
			case JSParser.CloseBracket:
				return RBRACKET;
			case JSParser.OpenParen:
				return LPAREN;
			case JSParser.CloseParen:
				return RPAREN;
			case JSParser.SemiColon:
				return SEMICOLON;
			case JSParser.Ellipsis:
				return DOT_DOT_DOT;
			case JSParser.Let:
				return LET;
			case JSParser.Const:
			...
			case JSParser.BitXorAssign:
				return JSTokenType.CARET_EQUAL;
			case JSParser.BitOr:
				return PIPE;
			case JSParser.BitOrAssign:
				return JSTokenType.PIPE_EQUAL;
			case JSParser.BitAnd:
				return AMPERSAND;
			case JSParser.BitAndAssign:
				return AMPERSAND_EQUAL;
			case JSParser.Comma:
				return JSTokenType.COMMA;
			case JSParser.Arrow:
				return ARROW;
			case JSParser.Assign:
				return EQUAL;
			case JSParser.QuestionMark:
				return JSTokenType.QUESTION;
			case JSParser.Colon:
				return JSTokenType.COLON;
			case JSParser.Dot:
				return DOT;
			...
			case JSParser.MinusMinus:
				return MINUS_MINUS;
			case JSParser.Plus:
				return JSTokenType.PLUS;
			case JSParser.Minus:
				return MINUS;
			case JSParser.BitNot:
				return JSTokenType.TILDE;
			case JSParser.Not:
				return EXCLAMATION;
			case JSParser.Divide:
				return JSTokenType.FORWARD_SLASH;
			...
			case JSParser.RightShiftLogical:
				return JSTokenType.GREATER_GREATER_GREATER;
			case JSParser.LessThan:
				return JSTokenType.LESS;
			case JSParser.MoreThan:
				return JSTokenType.GREATER;
			case JSParser.LessThanEquals:
				return JSTokenType.LESS_EQUAL;
			case JSParser.GreaterThanEquals:
				return JSTokenType.GREATER_EQUAL;
			case JSParser.Equals:
				return JSTokenType.EQUAL_EQUAL;
			case JSParser.NotEquals:
				return JSTokenType.EXCLAMATION_EQUAL;
			case JSParser.IdentityEquals:
				return EQUAL_EQUAL_EQUAL;
			case JSParser.IdentityNotEquals:
				return JSTokenType.EXCLAMATION_EQUAL_EQUAL;
			case JSParser.And:
				return JSTokenType.AMPERSAND_AMPERSAND;
			case JSParser.Or:
				return PIPE_PIPE;
