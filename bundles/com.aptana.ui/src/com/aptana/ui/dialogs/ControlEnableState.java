...
{
	/**
	 * List of exception controls (element type: <code>Control</code>); <code>null</code> if none.
	 */
	...
	/**
	 * Internal class for recording the enable/disable state of a single control.
	 */
	 ...
	 * the controls that are saved are also disabled.
	 * 
	 * @param w
	 *            the control
	 */
	 ...
	 *            the control
	 * @param exceptions
	 *            the list of controls to not disable (element type: <code>Control</code>), or <code>null</code> if none
	 */
	...
	/**
	 * Saves the current enable/disable state of the given control and its descendents in the returned object; the
	 * controls are all disabled.
	 * 
	 * @param w
	 *            the control
	...
	/**
	 * Saves the current enable/disable state of the given control and its descendents in the returned object except for
	 * the given list of exception cases; the controls that are saved are also disabled.
	 * 
	 * @param w
	 *            the control
	 * @param exceptions
	 *            the list of controls to not disable (element type: <code>Control</code>)
	 * @return an object capturing the enable/disable state
	 */
