...
public class TextEditorPlugin extends AbstractUIPlugin {
	...
	private IDocumentProvider textDocumentProvider;
	...
	/**
	 * Returns text document provider
	 * @return
	 */
	public synchronized IDocumentProvider getTextDocumentProvider() {
		if (textDocumentProvider == null) {
			textDocumentProvider = new TextDocumentProvider();
		}
