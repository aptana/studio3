	...
	try {
		...
		timestamps() {
			stage('Checkout') {
				...
				minimums = getCoverageMinimums("Studio/studio3/${targetBranch}")
			}
...
ftps.supports.permissions=false"""
				...
				step([$class: 'JacocoPublisher',
					...
					maximumBranchCoverage: minimums[0],
					maximumClassCoverage: minimums[1],
					maximumInstructionCoverage: minimums[2],
					maximumLineCoverage: minimums[3],
					maximumMethodCoverage: minimums[4],
					minimumBranchCoverage: minimums[0],
					minimumClassCoverage: minimums[1],
					minimumInstructionCoverage: minimums[2],
					minimumLineCoverage: minimums[3],
					minimumMethodCoverage: minimums[4],
