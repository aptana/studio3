...
public class PlatformSpecificCommandTests extends BundleTestBase
{
	...
	public void testCommandsForCurrentPlatform()
	{
		...
		//assertEndsWith("implicitAllPlatformString", executeCommand(commands[0]));
		//assertEndsWith("explicitAllPlatformString", executeCommand(commands[1]));
		...
		{
			assertEquals(22, commands.length);
			//assertEndsWith("windowsAndImplicitAllPlatformString", executeCommand(commands[5]));
			//assertEndsWith("windowsAndExplicitAllPlatformString", executeCommand(commands[6]));
			//assertEndsWith("windowsOnlyPlatformString", executeCommand(commands[7]));
			// TODO more
		}
