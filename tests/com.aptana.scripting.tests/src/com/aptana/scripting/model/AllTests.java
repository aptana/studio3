...
@RunWith(Suite.class)
@SuiteClasses({BundleCacherTest.class, BundleLoadingPerformanceTest.class, BundleTests.class, BundleVisibilityTests.class, CommandBlockRunnerTests.class, CommandTests.class, ContextTests.class, CommandBlockRunnerTests.class, FilterTests.class, KeyBindingTests.class, PlatformSpecificCommandTests.class, SnippetCategoryTests.class, WithDefaultsTests.class, ProjectBundleMonitorTests.class, UserBundleMonitorTests.class, })
