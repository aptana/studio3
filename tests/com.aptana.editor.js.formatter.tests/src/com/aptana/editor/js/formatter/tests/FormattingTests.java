...
public class FormattingTests extends AbstractFormatterTestCase
{
	...
	public void testFilesInFormattingFolder() throws Exception
	{
		...
		for (String filename : files)
		{
			...
			/*
			 * Test 11, 14, 21, 24, 3, 35, 36, 37, 38, 39, 40, 45, 48, 52, 61, 74, 79, 9, 73, 81, 83: Studio 1.5 seems to add/remove extra spaces/newlines in a line. (We currently don't do this)
			 */
