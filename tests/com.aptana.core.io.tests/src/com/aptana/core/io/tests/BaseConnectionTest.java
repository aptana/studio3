...
public abstract class BaseConnectionTest extends TestCase
{
	...
	protected String remoteFileDirectory = null; //actual path to the remote filesystem (if remote system can  be accesses via file:// protocol). You must have write privledges to this.
