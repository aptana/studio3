...
public class JSONFoldingComputerTest extends TestCase
{
	...
	public void testObjectInitiallyFolded() throws Exception
	{
		...
		new InstanceScope().getNode(JSONPlugin.PLUGIN_ID).putBoolean(IPreferenceConstants.INITIALLY_FOLD_OBJECTS, true);
	...
	public void testArrayInitiallyFolded() throws Exception
	{
		...
		new InstanceScope().getNode(JSONPlugin.PLUGIN_ID).putBoolean(IPreferenceConstants.INITIALLY_FOLD_ARRAYS, true);
